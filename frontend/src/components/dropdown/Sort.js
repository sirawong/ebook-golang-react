...
const sorts = [
  { sortby: 'Review', name: 'Review: High to Low', val: 'desc' },
  { sortby: 'Review', name: 'Review: Low to High', val: 'asc' },
  { sortby: 'Price', name: 'Price: High to Low', val: 'desc' },
  { sortby: 'Price', name: 'Price: Low to High', val: 'asc' },
];
